...
const Eventbar = () => {
  return (
    ...
    <div className='title text-bold text-xl text-center bg-primary w-80 justify-center grid-cols-1 text-white p-5'>Event Hype</div>
  
    <div className='flex  p-5'>
        
        <div className='font-semibold pr-2'> PrimaryColor </div>
